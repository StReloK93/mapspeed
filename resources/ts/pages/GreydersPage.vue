<template>
	<section class="fixed inset-0">
		...
		<AnalyzeGreyderJobs v-if="analyzeToggle" @close="analyzeToggle = false"/>
		...
		<div class="absolute bottom-3 left-0 p-2 z-50">
			...
			<button @click="analyzeToggle = true" class="bg-white px-4 ml-2 py-1.5 rounded-full">Анализ работы ДСМ</button>
		</div>
...
import GrayderModal from './GreydersComponents/GrayderModal.vue'
import GrayderModalSmena from './GreydersComponents/GrayderModalSmena.vue'
import AnalyzeGreyderJobs from './GreydersComponents/AnalyzeGreyderJobs.vue'
